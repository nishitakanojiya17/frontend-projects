    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('branch', models.CharField(default='AIML', max_length=50)),
                ('semester', models.PositiveSmallIntegerField(default=6)),
                ('section', models.CharField(default='B', max_length=5)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('child', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='parents', to='accounts.studentprofile')),
            ],
        ),
    ]
